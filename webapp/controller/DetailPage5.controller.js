sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.untitledPrototype.controller.DetailPage5", {
...
var oBindingContext = oEvent.getSource().getBindingContext();
		...
		onInit: function() {
			...
			// var oTreeNodeTemplate = new sap.ui.commons.TreeNode("node");
    		  //oTreeNodeTemplate.bindProperty("text", "tables");
    		 //oTreeNodeTemplate.setExpanded(true);

    		//tree.bindAggregation("node", "/sections", oTreeNodeTemplate);
					...
					if (sap.ui.Device.system.phone) {
						...
						if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
							...
							oPage.attachNavButtonPress(function() {
								this.oRouter.navTo("DetailPage3", {}, true);
							}.bind(this));
						}
					}
				}.bind(this)
